package com.lokatani.lokafreshinventory.yolo.predict.detect;
...
import com.lokatani.lokafreshinventory.yolo.models.YoloModel;
import com.lokatani.lokafreshinventory.yolo.predict.PredictorException;
...
public class TfliteDetector extends Detector {
    ...
    private final long lastFpsTime = System.currentTimeMillis();
    ...
    public TfliteDetector(Context context) {
        ...
        Bitmap pendingBitmapFrame = Bitmap.createBitmap(INPUT_SIZE, INPUT_SIZE, Bitmap.Config.ARGB_8888);
    ...
    private void setInput(Bitmap resizedbitmap) {
        ByteBuffer imgData = ByteBuffer.allocateDirect(INPUT_SIZE * INPUT_SIZE * 3 * NUM_BYTES_PER_CHANNEL);
